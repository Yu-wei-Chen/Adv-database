        ...
        <div class="col-md-12 column">
            <div class="row clearfix">
                ...
                <div class="col-md-10 column">
                    <form class="form-horizontal" role="form" action="Faculty_update.php" method="post">
                        <h3>
                            Edit Store
                        </h3>
                        <hr>
        ...
        <div class="col-md-12 column">
            <div class="footer">
                <div class="container">
                    ...
                    <div class="modal fade" id="fire" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                         aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">Are you sure you wanna fire this clerk?</div>
