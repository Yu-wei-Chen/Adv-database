...
//echo "neo4j connection start<BR>";
session_start();
...
<div class="container">
                ...
                <div class="col-md-10 column">
                    <div class="jumbotron">
                        <div id="question1_content">
                            ...
                            Welcome to Neo4j OLAP!
                            </h1>
                        </div>
                    </div>
                    <div class="alert alert-success alert-dismissable">
                        <h4 id="h4">
                            Data WareHouse System, you can view your data in <a href='http://localhost:7474/browser/'>neo4j </a>
                        </h4>
                        <!--question 1 filter-->
                        ...
                        <div id="q8_filter" style="display:none;";>
                            ...
                            <select id="q8_from" onchange="check8_from()">
                             ...
                             <label>To</label>
                            <select id="q8_to" onchange="check8_to()">
                             <!--<option value="">year month</option>-->
                ...
                <div class="container">
                    ...
                    <div class="row footer-bottom">
                        <ul class="list-inline text-center">
                            <li>Copyright &copy;2017. INFSCI 2711: Advance Database Management<br/>
    ...
    <script type="text/javascript">
       ...
       //javascript for graph
        ...
        //question 1 should be modified here, generate the pie graph
       ...
       var chart = new CanvasJS.Chart("chartContainer",
	{
		theme: "theme2",
		title:{
			text: "Ratio of bussiness to home customer"
		},
		data: [
		{
			type: "pie",
			...
			dataPoints: [
                <?php 
                $cipher = 'match (n:CustomerDim) return count(distinct n.customer_id) as custnum ';
                $query1 = new Everyman\Neo4j\Cypher\Query($client, $cipher);
                $result = $query1->getResultSet();
                $temp = 0;
                foreach ($result as $row) {
                    $temp = $row['custnum'];
                    //echo gettype($row['sum']);

                  }
         
                $cipher = 'match (n:CompanyDim) return count(distinct n.company_id) as compnum ';
                $query1 = new Everyman\Neo4j\Cypher\Query($client, $cipher);
                $result = $query1->getResultSet();
                $temp2 = 0;
                foreach ($result as $row) {
				...
				{  y: <?php echo $temp2?>, indexLabel: "Company customer" },
				{  y: <?php echo $temp?>, indexLabel: "Home customer" },
