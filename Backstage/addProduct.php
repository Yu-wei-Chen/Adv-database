        ...
        <div class="col-md-12 column">
            <div class="row clearfix">
                ...
                <div class="col-md-10 column">
                    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="Product_insert.php" method="post">
                        <h3>
                            Add Product
                        </h3>
                        <hr>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="kind" value="" >
                                    <option>Shoes</option>
                                    <option>Shirt</option>
                                    <option>bag</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input class="form-control"  name="inventory" value="" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Gender</label>
                            <div class="col-sm-2">
                                <input class="form-control"  name="gender" value="" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Description</label>
                            <div class="col-sm-6">
                                <textarea class="form-control" rows="5"  name="describe" value="" ></textarea>
                            </div>
                        </div>
                        <div class="form-group">
