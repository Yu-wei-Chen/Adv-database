...
<div class="main">
    ...
    <div class="container">
        <div class="register">
            ...
            <form action="company_registering.php" method="post">
                <div class="col-md-6  register-top-grid">

                    <div class="mation">
                        <span>Name</span>
                        <input type="text" name="name" value="pitt1">
                        <span>Address</span>
                        <input type="text" name="address" value="123321 street">
                        <span>State</span>
                        <input type="text" name="state" value="PA">
                        <span>Income</span>
                        <input type="text" name="income" value="100000000000">
                        <span>Category</span>
                ...
                <div class=" col-md-6 register-bottom-grid">
                    ...
                    <div class="mation">
                        <span>User Name</span>
                        <input type="text" name="username" value="pitt1">
                        <span>Password</span>
