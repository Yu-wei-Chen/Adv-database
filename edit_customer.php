...
<?php
            ...
            $sid = $_SESSION['id'];
            // Run a sql
            $sql = "SELECT * FROM Customer where ID_Customer = $sid "; // find the top 5 popular item
            ...
            $sql1 = "SELECT * FROM Login_Customer where ID_Customer = $sid "; // find the top 5 popular item
...
<div class="main">
    ...
    <div class="container">
        <div class="register">
            ...
            <form action="customer_editing.php" method="post">
                <div class="col-md-6  register-top-grid">
                    ...
                    <div class="mation">
                        ...
                        <span>Age</span>
                        <input type="text" name="Age" value=<?php echo $cage; ?>>
                        <span>Gender</span>
                        <input type="text" name="Gender" value=<?php echo $cgender; ?>>
                        <span>Address</span>
