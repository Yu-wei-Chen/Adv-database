...
// Question 1 answer 
$company_qty = $db->command(array("distinct" => "colltest8", "key" => "company_dim.company_id"));
$customer_qty = $db->command(array("distinct" => "colltest8", "key" => "customer_dim.customer_id"));
