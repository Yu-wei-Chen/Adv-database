...
session_start();
            ...
            if ($job == "super"){
                ...
                $sql = "SELECT * FROM Transaction where status = 'reject' "; 

            }elseif ($job == "manager") {
                
                $sql = "SELECT * FROM Transaction where status = 'reject' and ID_Store = $Sid "; 

            }else{

                $sql = "SELECT * FROM Transaction where status = 'reject' and ID_Store = $Sid and change_state = '$state' "; 
